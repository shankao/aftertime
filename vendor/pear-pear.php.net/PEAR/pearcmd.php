...
if ('/home/shankao/www/sites/aftertime/vendor/pear-pear.php.net/PEAR ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('/home/shankao/www/sites/aftertime/vendor/pear-pear.php.net/PEAR '));
    $raw = false;
} else {
